<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MasterPage.master" AutoEventWireup="true" CodeFile="S1Pack.aspx.cs" Inherits="User_Upgrade" %>
            ...
            <div class="border-gradient">
                <div class="border-gradient_content">
                    <div id="x42main" class="logotypeX4">
                        <h2 class="mb-3" style="color: #F8B940 !important; text-align: center;">WORKING PROGRAM</h2>
                    </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12">
                              <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand"
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="btnBuy" runat="server" CommandArgument='<%#Eval("PoolNo") %>' CommandName="BuyNow" CssClass="btn btn-success btn-block btn-width mb-1" Style="width:100%" Text='<%# Eval("name") %>' />
                                    <div class="table-responsive" id="divCheck" visible="false" runat="server" style="border:solid #fff 2px;">
                                        <table class="table basic-table table-hover" id="tblpackage" runat="server">
                                            <thead>
                                                <tr>
                                                    <td style=" background-color: #28a745; color: #fff">SLOT -<%#Eval("PoolNo") %></td>
