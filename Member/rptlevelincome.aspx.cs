...
public partial class User_Default2 : System.Web.UI.Page
{
    ...
    public void loadaccount(string username)
    {
        try
        {
            DataTable dt = objlist.UserIncomeList(SessionData.Get<string>("Newuser"), "NULL", "NULL", "POOL", "U");

            if (txtfromdate.Text != "" && txttodate.Text != "")
            {
                dt = objlist.UserIncomeList(SessionData.Get<string>("Newuser"), txtfromdate.Text, txttodate.Text, "POOL", "U");
