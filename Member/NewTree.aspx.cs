...
public partial class User_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (SessionData.Get<string>("newuser") != null)
            {
                ...
                hndPoolno.Value = PoolNo;
                LoadTree(UserName, PoolNo);
                title.InnerText = "Package-" + PoolNo + " Downline Tree";
            }
           
        }
    }

    private void LoadTree(string username,string PoolNo)
    {
        try {
            string sql = "exec [GetBinaryTreeView] '" + username + "','"+ PoolNo + "','A' ";
    ...
    {
        LoadTree(hnduserid1.Value, hndPoolno.Value);
    }

    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid2.Value, hndPoolno.Value);
    }

    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid3.Value, hndPoolno.Value);
    }

    protected void LinkButton4_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid4.Value, hndPoolno.Value);
    }

    protected void LinkButton5_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid5.Value, hndPoolno.Value);

    }

    protected void LinkButton6_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid6.Value, hndPoolno.Value);
    }

    protected void LinkButton7_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid7.Value, hndPoolno.Value);
    }

    protected void LinkButton8_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid8.Value, hndPoolno.Value);

    }

    protected void LinkButton9_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid9.Value, hndPoolno.Value);

    }

    protected void LinkButton10_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid10.Value, hndPoolno.Value);
    }

    protected void LinkButton11_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid11.Value, hndPoolno.Value);
    }

    protected void LinkButton12_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid12.Value, hndPoolno.Value);

    }

    protected void LinkButton13_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid13.Value, hndPoolno.Value);
    }

    protected void LinkButton14_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid14.Value, hndPoolno.Value);
    }

    protected void LinkButton15_Click(object sender, EventArgs e)
    {
        LoadTree(hnduserid15.Value, hndPoolno.Value);
    }
    ...
    {
        //LoadTree(txtsearch.Text, hndPoolno.Value);
    }
}