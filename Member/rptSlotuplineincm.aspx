<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MasterPage.master" AutoEventWireup="true" CodeFile="rptSlotuplineincm.aspx.cs" Inherits="User_Default2" %>
        ...
        <div class="col-lg-12">
            <div class="card cardoo">
                <div class="card-header">
                    <h5 class="card-title">SWISS BOX </h5>
                </div>
                                ...
                                <asp:GridView ID="grdData" runat="server"
                                    ...
                                    <Columns>
                                       ...
                                       <%-- <asp:BoundField DataField="username" HeaderText="UserName"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="Remark" HeaderText="Reamrk"></asp:BoundField>
