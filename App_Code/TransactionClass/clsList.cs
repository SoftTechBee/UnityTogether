...
namespace TripleITTransaction
{
    public class clsList  
    {
        ...
        public DataTable GetTreeView_(string Sponser)
        {


            SqlParameter prmSponser = new SqlParameter("@Sponser", Sponser);
            return ObjConnection.ReturnDataTable("TreeView_Tree", prmSponser);
        }
        public DataTable BindTree(string username)
        {
            SqlParameter ptrusername = new SqlParameter("@UserName", username);
            return ObjConnection.ReturnDataTable("GetBoxTree", ptrusername);

        }
        public DataTable BindMLTree(string username)
        {
            SqlParameter ptrusername = new SqlParameter("@UserName", username);
            return ObjConnection.ReturnDataTable("getx4boxtree", ptrusername);

        }
        public DataTable DashboardList(string username,string Type)
        {
            SqlParameter ptrusername = new SqlParameter("@UserName", username);
            SqlParameter ptrType = new SqlParameter("@Type", Type);
            return ObjConnection.ReturnDataTable("DashBoard", ptrusername, ptrType);

        }
        public DataTable AdminupdateWallet(string username,string Wallet,string NewWallet, string Type)
        {
            SqlParameter ptrusername = new SqlParameter("@UserName", username);
            SqlParameter ptrWallet = new SqlParameter("@Wallet", Wallet);
            SqlParameter ptrNewWallet = new SqlParameter("@NewWallet", NewWallet);
            SqlParameter ptrType = new SqlParameter("@Type", Type);
            return ObjConnection.ReturnDataTable("AdminupdateWallet", ptrusername, ptrType);

        }
        public DataTable PoolMemberStatus(string username,string Poolno,string Level, string Type)
        {
            SqlParameter ptrusername = new SqlParameter("@UserName", username);
            SqlParameter ptrPoolno = new SqlParameter("@Poolno", Poolno);
            SqlParameter ptrLevel = new SqlParameter("@Level", Level);
            SqlParameter ptrType = new SqlParameter("@Type", Type);
            return ObjConnection.ReturnDataTable("PoolMemberstatus", ptrusername, ptrPoolno, ptrLevel, ptrType);

        }
        public DataTable IncomeList(string username,string Type)
        {
            SqlParameter ptrusername = new SqlParameter("@UserName", username);
            SqlParameter ptrType = new SqlParameter("@Type", Type);
            return ObjConnection.ReturnDataTable("IncomeList", ptrusername, ptrType);

        }

        public DataTable UserIncomeList(string username, string FromDate, string ToDate,  string Valu, string Type)
        {
            SqlParameter ptrusername = new SqlParameter("@UserName", username);
            SqlParameter ptrFromDate = new SqlParameter("@FromDate", FromDate);
            SqlParameter ptrTodate = new SqlParameter("@Todate", ToDate);
            SqlParameter ptrValu = new SqlParameter("@Valu", Valu);
            SqlParameter ptrType = new SqlParameter("@Type", Type);
            return ObjConnection.ReturnDataTable("UserIncomeList", ptrusername, ptrFromDate, ptrTodate, ptrValu,ptrType);

        }
        public DataTable PayoutList(string FromDate, string ToDate, string Status)
        {
            ...
            return ObjConnection.ReturnDataTable("[worldmaindb].[PayoutList]", prmFromDate, prmToDate, prmStatus);
        }
    }
}
