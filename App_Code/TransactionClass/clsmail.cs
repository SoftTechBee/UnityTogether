...
public class clsmail
{
    ...
    public string sendpass(string Name, string Username, string pass, string TransactionPass, string Email)
    {
        try
        {
           ...
           string msg = "Dear " + Name + ",<br />Welcome toUnity Together.Your Registration has been Successfully completed.<br /><br /><bold>Your account details are as follows :</bold><br />Your UserName:-" + Username + "<br /> Your Password :-" + pass + "<br/>";
            ...
            msg += "info@unitytogether.live. We're always happy to help you..!!<br /><br />";
            msg += "<br/><br/>Cheers! <br/><h3> Team Unity Together<h3/> <br/>visit:-<a href=http://unitytogether.live>www.unitytogether.live</a>";

            MailAddress FromMailAddress = new MailAddress(MailUserName, "Unity Together");
    ...
    public string DepositeFund(string Name, string Amount, string to)
    {
        try
        {
            ...
            msg += "info@unitytogether.live We're always happy to help you.<br /><br />";
            msg += "<br/><h3> Team Unity Together<h3/> <br/>visit:-<a https://unitytogether.live>www.unitytogether.live</a>";
    ...
    public string WithdrawFund(string Name, string Amount, string PaymentType, string Adddress, string Email)
    {
        try
        {
            ...
            msg += "Should you have any questions, simply write a mail to.<br />info@unitytogether.live.We're always happy to help you..!!< br />";
    ...
    public string PackageActivate(string Name, string Amount, string to)
    {
        try
        {
            ...
            string SenderAddress = "info@unitytogether.live";
            ...
            theTestMail.Body += "info@unitytogether.live.We're always happy to help you..!!<br /><br />";
     ...
     public void OTP(string Username, string pass, string to)
    {
        try
        {
            ...
            string msg = "Dear " + Username + ".<br />Your OneTimePassword :-" + pass + " <br/> For Admin Login ";
            msg += "<br/><br/>Have a great day! <br/><h3>Team Unity Together<h3/> <br/>visit:-<a href=https://unitytogether.live>https://www.unitytogether.live</a>";
