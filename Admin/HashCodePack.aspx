<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="HashCodePack.aspx.cs" Inherits="Member_BuyNextPackage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <asp:Label runat="server" ID="lbwallet" CssClass="form-control"></asp:Label>
                    ...
                    <div class=" form-group row">
                        <label class="col-2 col-sm-6 col-lg-2 col-md-2">HashCode</label>
                        <div class="col-6 col-sm-6 col-lg-6 col-md-6">
<asp:TextBox runat="server" ID="txtHashcode" AutoPostBack="true" OnTextChanged="txtHashcode_TextChanged" CssClass="form-control"></asp:TextBox>
                        </div>
                        </div><br />
                    <div class="form-group row">
   <label class="col-2 col-sm-6 col-lg-2 col-md-2">Buy Package  </label>
   <div class="col-6 col-sm-6 col-lg-6 col-md-6">
    <asp:Label runat="server" ID="lbslot" CssClass="form-control"></asp:Label>
   </div>
   </div><br />
                         <div class="form-group row">
                        <label class="col-2 col-sm-6 col-lg-2 col-md-2">Package Amount </label>
                        <div class="col-6 col-sm-6 col-lg-6 col-md-6">
<asp:Label runat="server" ID="lbamt" CssClass="form-control"></asp:Label>
                        </div>
                        </div>
                     <br />
                     <div class="form-group row">
                           <div class="col-6 col-sm-6 col-lg-6 col-md-6">
                      <asp:Button ID="bntsubmit" runat="server" Text="Buy Now" CssClass="btn btn-block btn-success" OnClick="bntsubmit_Click" />
                               </div>
