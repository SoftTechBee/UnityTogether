<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="GetWalletAddress.aspx.cs" Inherits="Admin_WalletApprovedList" %>
    ...
    <ItemTemplate>
        <tr>
          ...
          <asp:Label ID="lbname" runat="server" Text='<%#Eval("UserName") %>'></asp:Label> </td>
           ...
           <%--  <td> <%#Eval("[Remark]") %></td>--%>
             <td> <%#Eval("[oldwallet]") %></td>
             <td> <%#Eval("[Newwallet]") %></td>
