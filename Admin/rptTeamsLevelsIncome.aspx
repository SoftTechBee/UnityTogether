<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="rptTeamsLevelsIncome.aspx.cs" Inherits="Admin_rptMachingIncome" %>
                ...
                <div class="form-group">
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="overflow: auto;">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped table-hover"
                            OnRowCommand="GridView1_RowCommand" AllowPaging="True" PageSize="50" OnPageIndexChanging="GridView1_PageIndexChanging" ShowFooter="true">
                            <Columns>
                                ...
                                <asp:BoundField DataField="DOA" HeaderText="DOA" DataFormatString="{0:dd/MM/yyyy}" />
                                ...
                                <asp:TemplateField HeaderText="View Income">
                                    <ItemTemplate>
                                        <asp:Button ID="btnView" runat="server" Text="View" CssClass="btn btn-block btn-warning"
                                            CommandArgument='<%# Eval("username") %>' CommandName="View" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
