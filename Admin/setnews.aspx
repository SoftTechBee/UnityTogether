                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lbTitle" runat="server" Text='<%#Eval("tittle") %>'></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lbnews" runat="server" Text='<%#Eval("news") %>'></asp:Label></td>
                                    <td>
                                        <asp:Button ID="Button1" runat="server" Text="Update" CommandArgument='<%#Eval("id") %>' CommandName="Update" CssClass="btn btn-block btn-success" /></td>
                                    <td>
