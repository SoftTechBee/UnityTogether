<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Incomes.aspx.cs" Inherits="Admin_rptlevelIncome" %>
        ...
        <div class="form-horizontal">
            <div class="card-body">
                <div class=" form-group row">
                    <div class=" col-lg-10">
                        <h2 class="card-title">All Income User  </h2>
                    </div>
                    <%--                                             
 <div class="  col-lg-2">
            ...
            <div class='input-group date' id='datetimepicker7'>
               ...
               <span class="input-group-addon">
                ...
                <tr>
                  ...
                  <th>Total</th>
                               <th>$<asp:Label ID="lbcredit" runat="server" Text=""></asp:Label> </th>
                               <th>$<asp:Label ID="lbdebit" runat="server" Text=""></asp:Label> </th>
                               <th>$<asp:Label ID="lbtotal" runat="server" Text=""></asp:Label> </th>
