...
using System.Data;
public partial class TreeCode_Default : System.Web.UI.Page
{
    ...
    private void LoadTree(string username)
    {
        try
        {
            string sql = "exec [dbo].[GetBinaryTreeView] '" + username + "','A' ";
            DataTable dt = objCon.ReturnDataTableSql(sql);
            if (dt.Rows.Count > 0)
            {
                //Level0
                Img1.Src = "TreeImg/" + dt.Rows[0]["Img"].ToString();
                LinkButton1.Text = dt.Rows[0]["Name"].ToString();
                hnduserid1.Value = dt.Rows[0]["UserName"].ToString();
                //Level1
                Img2.Src = "TreeImg/" + dt.Rows[1]["Img"].ToString();
                LinkButton2.Text = dt.Rows[1]["Name"].ToString();
                hnduserid2.Value = dt.Rows[1]["UserName"].ToString();

                Img3.Src = "TreeImg/" + dt.Rows[2]["Img"].ToString();
                LinkButton3.Text = dt.Rows[2]["Name"].ToString();
                hnduserid3.Value = dt.Rows[2]["UserName"].ToString();
                //Level2
                Img4.Src = "TreeImg/" + dt.Rows[3]["Img"].ToString();
                LinkButton4.Text = dt.Rows[3]["Name"].ToString();
                hnduserid4.Value = dt.Rows[3]["UserName"].ToString();

                Img5.Src = "TreeImg/" + dt.Rows[4]["Img"].ToString();
                LinkButton5.Text = dt.Rows[4]["Name"].ToString();
                hnduserid5.Value = dt.Rows[4]["UserName"].ToString();

                Img6.Src = "TreeImg/" + dt.Rows[5]["Img"].ToString();
                LinkButton6.Text = dt.Rows[5]["Name"].ToString();
                hnduserid6.Value = dt.Rows[5]["UserName"].ToString();

                Img7.Src = "TreeImg/" + dt.Rows[6]["Img"].ToString();
                LinkButton7.Text = dt.Rows[6]["Name"].ToString();
                hnduserid7.Value = dt.Rows[6]["UserName"].ToString();

                //level3
                Img8.Src = "TreeImg/" + dt.Rows[7]["Img"].ToString();
                LinkButton8.Text = dt.Rows[7]["Name"].ToString();
                hnduserid8.Value = dt.Rows[7]["UserName"].ToString();

                Img9.Src = "TreeImg/" + dt.Rows[8]["Img"].ToString();
                LinkButton9.Text = dt.Rows[8]["Name"].ToString();
                hnduserid9.Value = dt.Rows[8]["UserName"].ToString();

                Img10.Src = "TreeImg/" + dt.Rows[9]["Img"].ToString();
                LinkButton10.Text = dt.Rows[9]["Name"].ToString();
                hnduserid10.Value = dt.Rows[9]["UserName"].ToString();

                Img11.Src = "TreeImg/" + dt.Rows[10]["Img"].ToString();
                LinkButton11.Text = dt.Rows[10]["Name"].ToString();
                hnduserid11.Value = dt.Rows[10]["UserName"].ToString();

                Img12.Src = "TreeImg/" + dt.Rows[11]["Img"].ToString();
                LinkButton12.Text = dt.Rows[11]["Name"].ToString();
                hnduserid12.Value = dt.Rows[11]["UserName"].ToString();

                Img13.Src = "TreeImg/" + dt.Rows[12]["Img"].ToString();
                LinkButton13.Text = dt.Rows[12]["Name"].ToString();
                hnduserid13.Value = dt.Rows[12]["UserName"].ToString();

                Img14.Src = "TreeImg/" + dt.Rows[13]["Img"].ToString();
                LinkButton14.Text = dt.Rows[13]["Name"].ToString();
                hnduserid14.Value = dt.Rows[13]["UserName"].ToString();

                Img15.Src = "TreeImg/" + dt.Rows[14]["Img"].ToString();
